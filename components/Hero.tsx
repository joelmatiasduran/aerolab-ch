          ...
          <div className="absolute lg:top-32 md:top-20 top-10  left-0 container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
            <div className="">
              <div className="w-full">
                <h1 className="lg:max-w-3xl font-bold text-2xl md:text-4xl lg:text-5xl max-w-xs md:max-w-xl text-gray-900 leading-tight">
                ...
                <div className="pt-10 h-full min-h-full flex space-x-5 justify-center md:justify-start">
